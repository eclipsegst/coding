...
public class ReconstructItinerary {
	...
	public void dfs(String s, Map<String, PriorityQueue<String>> map, LinkedList<String> result) {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(solution.findItinerary(test1).toArray()));
		
		String[][] test2 = {{"JFK","SFO"},{"JFK","ATL"},{"SFO","ATL"},{"ATL","JFK"},{"ATL","SFO"}};
		System.out.println(Arrays.toString(solution.findItinerary(test2).toArray()));
	}
}
